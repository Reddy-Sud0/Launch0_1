          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center sm:items-start sm:flex-row gap-4">
              ...
              <div className="flex-grow pt-2 relative w-full">
                ...
                <div className="absolute left-0 top-[15%] w-[calc(100%+1rem)] h-px bg-gradient-to-r from-amber-500/20 via-amber-500/40 to-amber-500/20 -translate-x-4 hidden sm:block"></div>
                
                <div className="py-2">
                  <div className="flex flex-col sm:flex-row sm:items-center text-amber-400 justify-center">
                    <span className="font-medium text-amber-500 sm:text-amber-400 text-base md:text-xl mb-1 sm:mb-0 sm:mr-2 text-center sm:text-left">Date:</span>
                ...
                <div className="absolute left-0 top-[55%] w-[calc(100%+1rem)] h-px bg-gradient-to-r from-amber-500/20 via-amber-500/40 to-amber-500/20 -translate-x-4 hidden sm:block"></div>

                <div className="py-2">
                  <div className="flex flex-col sm:flex-row sm:items-center text-amber-400 justify-center">
                    <span className="font-medium text-amber-500 sm:text-amber-400 text-base md:text-xl mb-1 sm:mb-0 sm:mr-2 text-center sm:text-left">From:</span>
                ...
                <div className="absolute left-0 top-[95%] w-[calc(100%+1rem)] h-px bg-gradient-to-r from-amber-500/20 via-amber-500/40 to-amber-500/20 -translate-x-4 hidden sm:block"></div>
              </div>
            </div>
          </div>
